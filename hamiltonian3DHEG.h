#ifndef HAMILTONIAN3DHEG_H
#define HAMILTONIAN3DHEG_H

class imputVars;
#include "hamiltonianElements.h"

/*!
 * This class calculates the Hamiltonian matrix elements of the 3D Homogenous Electron Gas.
 */
class hamiltonian3DHEG : public hamiltonianElements
{
	private:
		int i_numpart;
		double d_k1;
