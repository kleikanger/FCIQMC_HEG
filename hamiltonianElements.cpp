#ifndef HAMILTONIANELEMENT_CPP
#define HAMILTONIANELEMENT_CPP
...
double hamiltonianElements::getDiagonalElement(
...
double hamiltonianElements::getSingleExcitationAmplitude (
		const int i_sk,
		const int i_sp,
		const int *pi_s) const
{
...
double hamiltonianElements::getDoubleExcitationAmplitude(
			const int iak, 
			const int ial,
			const int iap,
			const int iaq) const
